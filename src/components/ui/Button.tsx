...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "bg-accent text-bg-primary hover:bg-accent-hover active:bg-accent-hover/90",
  secondary:
    "bg-bg-card text-text-primary border border-border hover:bg-bg-card-hover hover:border-border-hover",
  danger:
